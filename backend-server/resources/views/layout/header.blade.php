            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    <button
                        ...
                        :aria-expanded="open"
                    >
                            <img class="w-8 h-8 rounded-full" src="{{Auth::user()->avatar}}" width="32"
                                 height="32" alt="User"/>
                    ...
                    >
                        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
                            ...
                            <div class="text-xs text-slate-500 italic">Free account</div>
                        </div>
                        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
                            <div class="font-medium text-slate-800"><a href="{{route('logout')}}">Logout</a></div>
                        </div>
